...
영어 원문을 직역하면 어색한 "번역투"가 됩니다. **반드시 자연스러운 한국어로 의역**하세요.
...
| 어색한 번역투 | 자연스러운 표현 | 원문 예시 |
|---------------|-----------------|-----------|
| 사고자, 생각자 | 생각이 느린 사람 | slow thinker |
| ~하는 것은 가능하다 | ~할 수 있다 | it is possible to~ |
| ~에 대해 흥분하고 있다 | ~이 기대된다 / ~에 설렌다 | excited about~ |
| 그것은 ~이다 | (주어 생략) ~이다 | It is~ |
| ~라는 사실 | ~다는 점 / ~다는 것 | the fact that~ |
| ~의 관점에서 | ~로 보면 / ~측면에서 | from the perspective of~ |
| ~를 수행하다 | ~를 하다 | perform~ |
| 기본적으로 | 사실 / 결국 / (생략) | basically |
| ~하는 경향이 있다 | ~하곤 한다 | tend to~ |
| ~에 의해 | ~로 / ~때문에 | by~ |

### 의역 예시

**어색:** "당신은 느린 사고자일 뿐이에요"
**자연스러움:** "당신보다 제가 더 빨리 생각하니까요" 또는 "당신은 생각이 느릴 뿐이에요"

**어색:** "이것이 제가 할 마지막 어려운 일일 수도 있습니다"
**자연스러움:** "이게 제가 마지막으로 도전하는 어려운 일이 될 수도 있어요"

**어색:** "우리는 그것에 대해 매우 흥분하고 있습니다"
**자연스러움:** "정말 기대되는 부분입니다" 또는 "이 부분이 특히 설렙니다"

### 의역 원칙
1. **의미 보존**: 원문의 핵심 뜻과 뉘앙스는 반드시 유지
2. **화자 어조 반영**: 격식/비격식, 자신감/겸손 등 유지
3. **전문용어는 유지**: 기술 용어는 번역하지 않거나 병기 (예: "스케일링 법칙(Scaling Laws)")
4. **짧은 문장 선호**: 한국어는 짧은 문장이 자연스러움
